      ...
      <div className="container mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex flex-col space-y-2">
            ...
            <p className="flex items-center justify-center md:justify-end mt-4 text-sm text-sky-200">
              Dibuat dengan <Heart className="w-4 h-4 mx-1 text-red-400" /> untuk anak-anak Indonesia
            </p>
          </div>
        </div>
        
        <div className="mt-8 pt-6 border-t border-sky-700 text-center text-sm text-sky-300">
          &copy; {new Date().getFullYear()} Feelio. All rights reserved.
        </div>
      </div>
    </footer>
  );
